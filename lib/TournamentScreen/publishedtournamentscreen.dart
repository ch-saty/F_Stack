...
class TournamentPublishedScreen extends StatefulWidget {
  const TournamentPublishedScreen({super.key});

  @override
  _TournamentPublishedScreenState createState() =>
      _TournamentPublishedScreenState();
}

class _TournamentPublishedScreenState extends State<TournamentPublishedScreen>
