...
class ScheduledLeagueScreen extends StatefulWidget {
  const ScheduledLeagueScreen({super.key});

  @override
  _ScheduledLeagueScreenState createState() => _ScheduledLeagueScreenState();
}
